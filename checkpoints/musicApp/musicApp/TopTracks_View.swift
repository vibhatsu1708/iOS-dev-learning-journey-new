...
struct TopTracks_View: View {
    @Binding var topTracks: [Song]
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                ForEach($topTracks, id: \.id) { $song in
                    HStack {
...
#Preview {
    TopTracks_View(topTracks: .constant([]), songID: .constant(0), songName: .constant("hello world"), songArtist: .constant("apple inc"), songCoverImage: .constant("4f718272-6b0e-42ee-92d0-805b783cb471"), songAccentColor: .constant("#331E00"), songURL: .constant("https://pub-172b4845a7e24a16956308706aaf24c2.r2.dev/august-145937.mp3"))
}
